...
class Appr(object):
    ...
    def train(self, t, xtrain, ytrain, xvalid, yvalid):
        ...
        if t == 0:
            ...
            # move a window of the last two tasks (unfreeze everything before)
            self.mask_pre2 = self.mask_pre1
            self.mask_pre1 = mask
            for i in range(len(self.mask_pre)):
                self.mask_pre[i] = torch.max(self.mask_pre1[i], self.mask_pre2[i])
