...
class Appr(object):
    ...
    def __init__(self,model,nepochs=100,sbatch=64,lr=0.05,lr_min=1e-4,lr_factor=3,lr_patience=5,clipgrad=100,c=0.1,xi=1e-3,decay=0.5,args=None,use_cuda=True):
        self.model=model
        self.model_old=None
