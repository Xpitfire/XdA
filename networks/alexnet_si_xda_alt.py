...
from networks.activations import XdAv2
...
class Net(torch.nn.Module):
    ...
    def __init__(self, inputsize, taskcla):
        ...
        self.c1_xda = XdAv2([tasks, 64, 29, 29])
        self.c2_xda = XdAv2([tasks, 128, 12, 12])
        self.c3_xda = XdAv2([tasks, 256, 5, 5])
        self.fc1_xda = XdAv2([tasks, 2048])
        self.fc2_xda = XdAv2([tasks, 2048])
