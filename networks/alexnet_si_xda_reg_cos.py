...
from networks.activations import RegCosXdA
...
class Net(torch.nn.Module):
    ...
    def __init__(self, inputsize, taskcla):
        ...
        self.c1_xda = RegCosXdA([tasks, 64, 29, 29])
        self.c2_xda = RegCosXdA([tasks, 128, 12, 12])
        self.c3_xda = RegCosXdA([tasks, 256, 5, 5])
        self.fc1_xda = RegCosXdA([tasks, 2048])
        self.fc2_xda = RegCosXdA([tasks, 2048])
